// Advanced Trading WebSocket Example
//
// This example demonstrates manual control over the trading WebSocket connection lifecycle,
...
//
// For simpler usage, see trading_websocket.rs which uses the convenient .run() method.
//
// To run this example:
// 1. Set your environment variables (optional):
//    - APCA_API_KEY_ID=your_api_key
//    - APCA_API_SECRET_KEY=your_secret_key
// 2. Run: cargo run --example trading_websocket_advanced --features "websocket"
