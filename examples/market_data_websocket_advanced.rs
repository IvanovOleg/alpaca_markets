// Advanced Market Data WebSocket Example
//
// This example demonstrates manual control over the WebSocket connection lifecycle,
// giving you full control over message processing, error handling, and reconnection logic.
// Use this approach when you need custom behavior beyond the simple .run() method.
//
// For simpler usage, see market_data_websocket.rs which uses the convenient .run() method.
//
// To run this example:
// 1. Set your environment variables:
//    - APCA_API_KEY_ID=your_api_key
//    - APCA_API_SECRET_KEY=your_secret_key
// 2. Run: cargo run --example market_data_websocket_advanced --features "websocket"
